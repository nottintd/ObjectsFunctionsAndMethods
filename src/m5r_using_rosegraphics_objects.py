...
#              clone, attach_to, and detach_from
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#               Center, fill_color, outline_color
#
#     f. What does a RoseWindow RENDER method do?
#            The objects attached to the window will not appear until you render them to the window using this method
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It's necessary when you will be using multiple windows such as in this project.
#           For example, the function will not call upon example2() until the window from example1() is closed.
