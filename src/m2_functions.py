...
def turtle5():
    #Completing TO DO 5
    TD = rg.SimpleTurtle('circle')
    TD.pen = rg.Pen('green', 15)
    TD.draw_square(40)

    nottingham = rg.SimpleTurtle('square')
    nottingham.pen = rg.Pen('yellow', 50)
    nottingham.draw_regular_polygon(3, 100)
